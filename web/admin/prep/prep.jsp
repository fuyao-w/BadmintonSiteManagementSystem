...
%>
<HTML><HEAD><TITLE>后台操作区</TITLE></HEAD>
...
<table width='100%' cellspacing='1' cellpadding='3' bgcolor='#CCCCCC' class="tablewidth">
     <tr class="head" id="blog">
      ...
      <td   width="15%"  class="center">订单会员</td>
      <td   width="10%"  class="center">当前状态</td>
      <td   width="10%"  class="center">付款方式</td>
      <td   width="20%"  class="center">预订时间</td>
      <td   width="10%"  class="center">处理</td>
	...
	<%--<tr  class="trA" onMouseOver="this.className='trB'" onMouseOut="this.className='trA'"> --%>
      ...
      <%--<td  bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>admin/prep/info.jsp?ddid=<%=pagelist2.get(1).toString()%>">查看详细</a></td>--%>
      <%--<td  bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>NewsServlet?method=fDD&ddid=<%=pagelist2.get(1).toString()%>">处理</a></td>--%>
      <%--<td  bgcolor="#FFFFFF"  style="border-bottom:1px dotted #ccc;"><a href="<%=basePath %>NewsServlet?method=dDD&ddid=<%=pagelist2.get(1).toString()%>">删除</a></td>--%>
    <%--</tr>--%>
<%--<%--%>
	<%--}} --%>
<%--%>  --%>
